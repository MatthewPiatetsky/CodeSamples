...
public class NewUserDao {
  ...
  private static final String NEW_USER_STMT = "INSERT INTO " +
    ...
    private static final String ALL_USER_SCORES = "SELECT Comments.user_id,Count(*) as cnt FROM (Comments LEFT JOIN (USERS LEFT JOIN Pictures on Pictures.email=Users.email) on Comments.user_id=Users.user_id) GROUP BY Comments.user_id ORDER BY cnt DESC";
